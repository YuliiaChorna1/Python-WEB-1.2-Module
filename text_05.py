# Фасад (Facade)
# Паттерн проектування, який надає простий інтерфейс до 
# складної системі класів, бібліотеки або фреймворку.
# Паттерн вирішує проблему, коли бізнес-логіка ваших класів тісно починає 
# переплітатися з деталями реалізації сторонніх бібліотек. 
# Код стає заплутаним, а заплутаний код стає важче підтримувати. 
# Для таких цілей і використовують патерн Фасад. 
